...
#define INIT_DUTY 500 //u16(1000/0.25)
...
void SetPwm_1(int16_t pwm[MAXMOTORS],s16 min,s16 max)
{
	u8 i;
	...
	TIM1->CCR4 = pwm_tem[3] + INIT_DUTY;				//4
	TIM1->CCR3 = pwm_tem[2] + INIT_DUTY;				//3
	TIM1->CCR2 = pwm_tem[1] + INIT_DUTY;				//2	
	TIM1->CCR1 = pwm_tem[0] + INIT_DUTY;				//1
